...
public final class Tag {
    ...
    public final class DAO {
        ...
        public static Set<Tag> ofProduct(Connection connection, int productId) {
            ...
            try( 
                //var statement = connection.prepareStatement("select * from product where productId = " + productId);
                var statement = DAOUtils(connection, Queries.TAGS_FOR_PRODUCT, productId);
